...
The dataset is generated directly in the notebook using NumPy 🔢 (no external files required). It includes:

* 📅 Monthly sales data
* 📚 Subject scores
* ⏱️ Study hours and exam scores
* 📦 Product sales distribution

---

## ✅ Task 1: Monthly Sales Trend (Line Plot)

A **line plot** is used to show how sales change over the months 📉📈
...
## ✅ Task 2: Subject Score Comparison (Bar Plot)

A **bar plot** is used to compare scores across different subjects 📊
...
## ✅ Task 3: Study Hours vs Exam Score (Scatter Plot)
...
## ✅ Task 4: Product Sales Distribution (Box Plot)
...
* 📈 Creating different types of plots (line, bar, scatter, box)
